...
export default class RecursionsNegativeStageAU {
    constructor(){}

    async recursiveNegativeTestStageGoddesAU(wrongEmail: string, stageLink: string): Promise<any> {
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_STAGE_LINKS.goddes){
            ...
            methods.sleep(1000)
            await ctx.close();
            return this.recursiveNegativeTestStageGoddesAU(wrongEmail, stageLink);
        }
    }

    async recursiveNegativeTestStagePharaohAU(wrongEmail: string, stageLink: string): Promise<any> {
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_STAGE_LINKS.pharaoh){
            ...
            methods.sleep(1000)
            await ctx.close();
            return this.recursiveNegativeTestStagePharaohAU(wrongEmail, stageLink);
        }
    }
}